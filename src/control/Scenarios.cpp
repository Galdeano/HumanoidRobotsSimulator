...
void Scenario_desired_trajectory1(double *qd, double t, int *desired_support, double *distribution)
{
...
void Scenario_desired_trajectory2(double *qd, double t, int *desired_support, double *distribution)
{
...
void Scenario_desired_trajectory3(double *qd, double t, int *desired_support, double *distribution)
{
...
void Scenario_desired_trajectory4(double *qd, double t, int *desired_support, double *distribution)
{
...
void Scenario_desired_trajectory5(double *qd, double t, int *desired_support, double *distribution)
{
...
void Scenario_desired_trajectory6(double *qd, double t, int *desired_support, double *distribution)
{
...
void Scenario_desired_trajectory7(double *qd, double t, int *desired_support, double *distribution)
{
...
{
    if (Sc1) {
        Scenario_desired_trajectory1(qd, t, desired_support, distribution);
    } else if (Sc2) {
        Scenario_desired_trajectory2(qd, t, desired_support, distribution);
    } else if (Sc3) {
        Scenario_desired_trajectory3(qd, t, desired_support, distribution);
    } else if (Sc4) {
        Scenario_desired_trajectory4(qd, t, desired_support, distribution);
    } else if (Sc5) {
        Scenario_desired_trajectory5(qd, t, desired_support, distribution);
    } else if (Sc6) {
        Scenario_desired_trajectory6(qd, t, desired_support, distribution);
    } else if (Sc7) {
        Scenario_desired_trajectory7(qd, t, desired_support, distribution);
    }
}
