...
//    float tmp_tab3[3], tmp_tab9[9];
    ...
    ezxml_t robot = ezxml_parse_file(RobotFile), State, Link, Contacts;
...
//    for (team = ezxml_child(robot, "team"); team; team = team->next) {
//        numlink = ezxml_attr(team, "name");
//        for (driver = ezxml_child(team, "driver"); driver; driver = driver->next) {
//            printf("%s, %s: %s\n", ezxml_child(driver, "name")->txt, numlink,
